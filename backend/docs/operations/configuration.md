...
Hosted mode being syntactically valid does not waive the benchmark, privacy, legal, residency, retention, or operational gates in `docs/architecture/parser.md`.
