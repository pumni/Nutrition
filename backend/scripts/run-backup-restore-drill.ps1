...
$sourceProject = "nutrition-recovery-source-$([Guid]::NewGuid().ToString('N').Substring(0, 12))"
...
$evidence = [ordered]@{
    ...
    policy = [ordered]@{
        ...
        retention_days = 35
        encryption = "Platform encryption remains required; local artifact used ephemeral AES-256-CBC and emitted no key"
